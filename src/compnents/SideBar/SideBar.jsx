  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <GlobalStyles
        styles={{
          body: {
            backgroundColor: "#081027", // Set the body background color
            margin: 0,
            padding: 0,
            fontFamily: "Roboto, sans-serif", // Optional: Ensure consistent font
          },
        }}
      />
      ...
      <Box
        component="main"
        sx={{ flexGrow: 1, p: "0 24px 24px 24px" }}
        style={{ backgroundColor: "#081027" }}
      >
        {props.children}
      </Box>
    </Box>
